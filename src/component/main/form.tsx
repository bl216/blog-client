...
import MainFeaturedPost from '../mainFeaturedPost/form';
import FeaturedPost from '../featuredPost/form';
import Body from '../body/form';
import Sidebar from '../sidebar/form';
import Footer from '../footer/form';
            ...
            <Container maxWidth="lg">
                ...
                <main>
                    ...
                    <Grid container spacing={5} sx={{ mt: 3 }}>
                        <Body title="From the firehose" posts={posts} />
                        <Sidebar
                            title={sidebar.title}
